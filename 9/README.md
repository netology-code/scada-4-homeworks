...
a. Имя проекта – ваши фамилия и инициалы

b. Создать два экрана в каждом располагаются по 3 стола*, на каждом экране должна быть кнопка аварийного останова, столы должны менять цвет в зависимости от своего состояния.

c. Кнопки старта и остановки для каждого стола.

d. Окно с ошибками (ошибки должны генерироваться при нажатии аварийного останова)

e. Каждый экран должен иметь кнопку перехода на соседние экраны
...
Вы можете прислать скрины, но по ним должны быть видны выполненные шаги a-e пункта 2 задания.

>> **Стол - транспортный узел, отвечающий за перемещение деталей.**
