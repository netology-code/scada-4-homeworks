...
2. Откройте [проект MasterSCADA 4D](https://disk.yandex.ru/d/Nx4BhcEp-R4lFw)  и  [проект ОРС-сервера](https://disk.yandex.ru/d/0Cr5Zf7pt9t9NQ).
3. В проекте MasterSCADA создайте мнемосхему и привяжите элементы к тегам OPC-сервера согласно заданию.
